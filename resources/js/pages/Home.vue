  ...
  <section class="cards-blog latest-blog">
    <div class="card-blog-content">
      ...
      <h4 style="font-weight: bolder">
        ...
        <li><router-link :to="{name:'SingleBlog', params:{slug:'Benefits-of-Getting-Covid-19-Vaccination'}}">Benefits of Getting Covid 19 Vaccination</router-link></li>
      </h4>
    </div>
    ...
    <div class="card-blog-content">
      ...
      <h4 style="font-weight: bolder">
        ...
        <li><router-link :to="{name:'SingleBlog', params:{slug:'Top-10-Music-Stories-Never-Told'}}">Top 10 Music Stories Never Told</router-link></li>
